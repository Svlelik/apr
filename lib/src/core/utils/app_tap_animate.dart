...
class _AppTapAnimateState extends State<AppTapAnimate>
  ...
  void initState() {
    super.initState();
    _scaleTween = Tween<double>(begin: 1, end: widget.pressedScale);
  ...
  void _animate() {
    ...
    final TickerFuture ticker = _widgetHeldDown
        ? _animationController.animateTo(1, duration: kScaleDownDuration)
        : _animationController.animateTo(0, duration: kScaleUpDuration);
